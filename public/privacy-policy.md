...
You can control the media and text you add to PolyPlay Audio. You can also delete app content, remove the app, or clear local or browser storage using your device or browser controls.
...
This Privacy Policy may be updated from time to time. The latest version will be posted wherever PolyPlay Audio makes this policy available, and the effective date above will be updated when material changes are made.
